...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--generator", type=str, default="G.pth", help="Generator model file."
    )
    ...
    model = load_model(model, model_file=args.generator)
    model.eval()
    ...
    if args.plot:
        ...
        plt.savefig(
            os.path.join(
                "plot-samples", args.generator.replace(".pth", ".png").replace(".", "_")
            )
        )
        plt.show()
